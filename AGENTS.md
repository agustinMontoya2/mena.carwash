...
- `scripts/ship.ps1 -Id <ID> -Summary "<english summary>"` - stages everything, commits with `MCS-<ID>: <summary>`, and pushes the branch. Does **not** create a PR. Run it only when the user asks for the commit.
